...
<div  class="box">
    ...
    <div class="box-header">
        ...
        <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Polis</button>
    </div><?php } else { ?>
    ...
    <div  class="box box-default">
        <div  class="box-header with-border">
            ...
            <div class="box-tools pull-right">
                <?php echo '<a href="javascript:void(0)" class="btn btn-box-tool" title="Edit" onclick="edit_pesan(' . "'" . $polis[0]['id_pesan'] . "'" . ')"><i class="glyphicon glyphicon-pencil"></i></a>'; ?>
