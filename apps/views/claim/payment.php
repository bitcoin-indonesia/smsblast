<div class="box"><div id="payment">
    ...
    <div class="box-header">
        ...
        <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Payment</button>
    </div><?php } else { ?>
...
$(document).ready(function () {
    table = $('#table').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo site_url('claim/payment/ajax_list') ?>",
            "type": "POST"
        },
        "columnDefs": [
            {
...
function delete_person(id_admin)
{
    if (confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url: "<?php echo site_url('claim/payment/ajax_delete') ?>/" + id_admin,
            type: "POST",
            dataType: "JSON",
            success: function (data)
            {
