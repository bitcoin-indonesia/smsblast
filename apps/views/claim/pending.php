<div class="box"><div id="pending">
    ...
    <div class="box-header">
        ...
        <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Pending</button>
    </div><?php } else { ?>
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">Claim</h3>
            <div class="box-tools pull-right">
                <?php echo '<a href="javascript:void(0)" class="btn btn-box-tool" title="Edit" onclick="edit_pesan(' . "'" . $pending[0]['id_pesan'] . "'" . ')"><i class="glyphicon glyphicon-pencil"></i></a>'; ?>
...
$(document).ready(function () {
    table = $('#table').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo site_url('claim/pending/ajax_list') ?>",
            "type": "POST"
        },
        "columnDefs": [
            {
