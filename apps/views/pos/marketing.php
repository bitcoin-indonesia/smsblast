<div class="box"><div id="marketing">
    <?php if(count($marketing)== 0)  {  ?>
    <div class="box-header">
        <h3 class="box-title"></h3>
        <button class="btn btn-success" onclick="add_marketing()"><i class="glyphicon glyphicon-plus"></i> Marketing</button>
    </div><?php } else { ?>
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">POS</h3>
            <div class="box-tools pull-right">
                <?php echo '<a href="javascript:void(0)" class="btn btn-box-tool" title="Edit" onclick="edit_pesan_marketing(' . "'" . $marketing[0]['id_pesan'] . "'" . ')"><i class="glyphicon glyphicon-pencil"></i></a>'; ?>
        ...
        <div id="parent">
            <div id="wide" class="box-body">
                <strong>Jenis Pesan</strong> : Marketing<br>
                <strong>Isi pesan</strong> : <?php echo $marketing[0]['isi_pesan'];?><br>
                <span class="label label-success"><strong>Preview Pesan</strong> : <?php echo str_replace("[2]",$member[0]['no_polis'],str_replace("[1]",$member[0]['nama'],$marketing[0]['isi_pesan']));?></span><br>
                <strong>Text Counter</strong> : <?php echo strlen(str_replace("[2]",$member[0]['no_polis'],str_replace("[1]",$member[0]['nama'],$marketing[0]['isi_pesan'])));?> Character<br>
            </div>
        </div> 
        <hr>
    </div> 
...
$(document).ready(function () {
    table = $('#table').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo site_url('pos/marketing/ajax_list') ?>",
            "type": "POST"
        },
        "columnDefs": [
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Marketing FORM</h3>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btnSave" onclick="save_marketing()" class="btn btn-primary">Save</button>
