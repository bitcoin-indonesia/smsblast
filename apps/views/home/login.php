...
<body class="hold-transition login-page " style="background-image: url(<?php echo base_url() ?>assets/images/login_bg.jpg); background-size: 100% 100%; background-position: center; background-repeat: no-repeat;" >
  ...
  <div class="login-logo">
      <a href="<?php echo base_url() ?>dashboard"><b>LOGIN</b> ADMIN</a>
  </div>
    <?php
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url()?>login" method="post">
      <div class="form-group has-feedback">
          <input type="username" required name="nama_lengkap" class="form-control" placeholder="Username">
    ...
    <div class="login-box-body">
        ...
        <a href="<?php echo base_url()?>home"><button type="submit" class="btn btn-primary btn-block btn-flat">To Dashboard</button></a><br>
