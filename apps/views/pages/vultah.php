...
<div class="box">
    ...
    <div class="box-header">
        ...
        <button class="btn btn-success" onclick="add_ultah()"><i class="glyphicon glyphicon-plus"></i> Ucapan</button>
    </div><?php } else { ?>
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">Ucapan</h3>
            <div class="box-tools pull-right">
                <?php echo '<a href="javascript:void(0)" class="btn btn-box-tool" title="Edit" onclick="edit_pesan_ultah(' . "'" . $ultah[0]['id_pesan'] . "'" . ')"><i class="glyphicon glyphicon-pencil"></i></a>'; ?>
        ...
        <div id="parent">
            <div id="wide" class="box-body">
                <strong>Jenis Pesan</strong> : ULTAH<br>
                <strong>Isi pesan</strong> : <?php echo $ultah[0]['isi_pesan'];?><br>
               <span class="label label-success"><strong>Preview Pesan</strong> : <?php echo str_replace("[2]",$member[0]['no'],str_replace("[1]",$member[0]['nama'],$ultah[0]['isi_pesan']));?></span><br>
                <strong>Text Counter</strong> : <?php echo strlen(str_replace("[2]",$member[0]['no'],str_replace("[1]",$member[0]['nama'],$ultah[0]['isi_pesan'])));?> Character<br>
<!--                <strong>Jumlah</strong> : <?php echo count($member) ?> Orang ultah hari ini<br>-->
            </div>
        </div> 
        <hr>
    </div> 
...
$(document).ready(function () {
    table = $('#table').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo site_url('ucapan/ultah/ajax_list') ?>",
            "type": "POST"
        },
        "columnDefs": [
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="btnSave" onclick="save_ultah()" class="btn btn-primary">Save</button>
