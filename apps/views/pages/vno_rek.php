...
<div class="box"><div id="norek">
    <?php if(count($no_rek)== 0)  {  ?>
    <div class="box-header">
        <h3 class="box-title"></h3>
        <button class="btn btn-success" onclick="add_no_rek()"><i class="glyphicon glyphicon-plus"></i> no rek</button>
    </div><?php } else { ?>
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">POS</h3>
            <div class="box-tools pull-right">
                <?php echo '<a href="javascript:void(0)" class="btn btn-box-tool" title="Edit" onclick="edit_pesan_no_rek(' . "'" . $no_rek[0]['id_pesan'] . "'" . ')"><i class="glyphicon glyphicon-pencil"></i></a>'; ?>
        ...
        <div id="parent">
            <div id="wide" class="box-body">
                <strong>Jenis Pesan</strong> : NO Rekening<br>
                <strong>Isi pesan</strong> : <?php echo $no_rek[0]['isi_pesan'];?><br>
                <span class="label label-success"><strong>Preview Pesan</strong> : <?php echo str_replace("[2]",$member[0]['no_polis'],str_replace("[1]",$member[0]['nama'],$no_rek[0]['isi_pesan']));?></span><br>
                <strong>Text Counter</strong> : <?php echo strlen(str_replace("[2]",$member[0]['no_polis'],str_replace("[1]",$member[0]['nama'],$no_rek[0]['isi_pesan'])));?> Character<br>
            </div>
        </div> 
        <hr>
    </div> 
...
$(document).ready(function () {
    table = $('#table').DataTable({
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo site_url('pos/no_rek/ajax_list') ?>",
            "type": "POST"
        },
        "columnDefs": [
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">No Rek FORM</h3>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="btnSave" onclick="save_no_rek()" class="btn btn-primary">Save</button>
