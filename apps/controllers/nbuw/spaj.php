...
class Spaj extends CI_Controller {
...
//                $t['spaj'] = $this->mpesan->td_get_spaj();
//                $t['member'] = $this->mpesan->td_get_member();
//                $a['admin']['datatable']= $this->load->view('nbuw/spaj',$t,true);
//                
//                $this->load->view('pages/vpesan',$a,FALSE);
                $t['spaj'] = $this->mpesan->td_get_spaj();
                $t['member'] = $this->mpesan->td_get_member();
                $this->load->view('pages/vspaj',$t);
	}
