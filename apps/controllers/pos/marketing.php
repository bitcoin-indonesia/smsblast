...
//                $t['marketing'] = $this->mpesan->td_get_marketing();
//                $t['member'] = $this->mpesan->td_get_member();
//                $a['admin']['datatable']= $this->load->view('pos/marketing',$t,true);
//                
//                $this->load->view('pages/vpesan',$a,FALSE);
            $t['marketing'] = $this->mpesan->td_get_marketing();
            $t['member'] = $this->mpesan->td_get_member();
            $this->load->view('pages/vmarketing',$t);
	}
	...
	public function ajax_add()
	{
            ...
            $this->admin_log->log_add_marketing();
	...
	public function ajax_update()
	{
            ...
            $this->admin_log->log_edit_marketing();
            echo json_encode(array("status" => TRUE));
	}
