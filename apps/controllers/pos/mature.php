...
class Mature extends CI_Controller {
...
//                $t['mature'] = $this->mpesan->td_get_mature();
//                $t['member'] = $this->mpesan->td_get_member();
//                $a['admin']['datatable']= $this->load->view('pos/mature',$t,true);
//                
//                $this->load->view('pages/vpesan',$a,FALSE);
            $t['mature'] = $this->mpesan->td_get_mature();
            $t['member'] = $this->mpesan->td_get_member();
            $this->load->view('pages/vmature',$t);
	...
	public function ajax_update()
	{
            ...
            $this->admin_log->log_edit_mature();
            echo json_encode(array("status" => TRUE));
	}
