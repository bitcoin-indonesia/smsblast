...
//                $t['alamat'] = $this->mpesan->td_get_alamat();
//                $t['member'] = $this->mpesan->td_get_member();
//                $a['admin']['datatable']= $this->load->view('pos/alamat',$t,true);
//                
//                $this->load->view('pages/vpesan',$a,FALSE);
            $t['alamat'] = $this->mpesan->td_get_alamat();
            $t['member'] = $this->mpesan->td_get_member();
            $this->load->view('pages/valamat',$t);
	}
	...
	public function ajax_update()
	{
            ...
            $this->admin_log->log_edit_alamat();
            echo json_encode(array("status" => TRUE));
	}
