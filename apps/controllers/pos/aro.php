...
//                $t['aro'] = $this->mpesan->td_get_aro();
//                $t['member'] = $this->mpesan->td_get_member();
//                $a['admin']['datatable']= $this->load->view('pos/aro',$t,true);
//                
//                $this->load->view('pages/vpesan',$a,FALSE);
            $t['aro'] = $this->mpesan->td_get_aro();
            $t['member'] = $this->mpesan->td_get_member();
            $this->load->view('pages/varo',$t);
	}
