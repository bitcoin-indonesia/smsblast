...
class Surender extends CI_Controller {
...
//                $t['surender'] = $this->mpesan->td_get_surender();
//                $t['member'] = $this->mpesan->td_get_member();
//                $a['admin']['datatable']= $this->load->view('pos/surender',$t,true);
//                
//                $this->load->view('pages/vpesan',$a,FALSE);
            $t['surender'] = $this->mpesan->td_get_surender();
            $t['member'] = $this->mpesan->td_get_member();
            $this->load->view('pages/vsurender',$t);
	}
	...
	public function ajax_add()
	{
            ...
            $this->admin_log->log_add_surender();
	...
	public function ajax_update()
	{
            ...
            $this->admin_log->log_edit_surender();
            echo json_encode(array("status" => TRUE));
	}
