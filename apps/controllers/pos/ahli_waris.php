...
//                $t['ahli_waris'] = $this->mpesan->td_get_ahli_waris();
//                $t['member'] = $this->mpesan->td_get_member();
//                $a['admin']['datatable']= $this->load->view('pos/ahli_waris',$t,true);
//                
//                $this->load->view('pages/vpesan',$a,FALSE);
            
            $t['ahli_waris'] = $this->mpesan->td_get_ahli_waris();
            $t['member'] = $this->mpesan->td_get_member();
            $this->load->view('pages/vahli_waris',$t);
	}
	...
	public function ajax_add()
	{
            ...
            $this->admin_log->log_add_ahli_waris();
	...
	public function ajax_update()
	{
            ...
            $this->admin_log->log_edit_ahli_waris();
            echo json_encode(array("status" => TRUE));
	}
