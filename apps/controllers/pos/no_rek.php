...
class No_rek extends CI_Controller {
...
//                $t['no_rek'] = $this->mpesan->td_get_no_rek();
//                $t['member'] = $this->mpesan->td_get_member();
//                $a['admin']['datatable']= $this->load->view('pos/no_rek',$t,true);
//                
//                $this->load->view('pages/vpesan',$a,FALSE);
            $t['no_rek'] = $this->mpesan->td_get_no_rek();
            $t['member'] = $this->mpesan->td_get_member();
            $this->load->view('pages/vno_rek',$t);
	}
	...
	public function ajax_update()
	{
            ...
            $this->admin_log->log_edit_no_rek();
            echo json_encode(array("status" => TRUE));
	}
