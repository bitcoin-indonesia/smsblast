...
//                $t['payment'] = $this->mpesan->td_get_pay_claim();
//                $t['member'] = $this->mpesan->td_get_member();
//                $a['admin']['datatable']= $this->load->view('claim/payment',$t,true);
//                
//                $this->load->view('pages/vpesan',$a,FALSE);
                $t['payment'] = $this->mpesan->td_get_pay_claim();
                $t['member'] = $this->mpesan->td_get_member();
                $this->load->view('pages/vclaim_pay',$t);
	}
	...
	public function ajax_add()
	{
            ...
            $this->mpesan->save($data);
             $this->admin_log->log_add_claim_payment();
	...
	public function ajax_update()
	{
            ...
            $this->admin_log->log_edit_claim_payment();
            echo json_encode(array("status" => TRUE));
	}
