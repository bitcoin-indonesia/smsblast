...
//                $t['pending'] = $this->mpesan->td_get_pending();
//                $t['member'] = $this->mpesan->td_get_member();
//                $a['admin']['datatable']= $this->load->view('claim/pending',$t,true);
//                
//                $this->load->view('pages/vpesan',$a,FALSE);
                $t['pending'] = $this->mpesan->td_get_pending();
                $t['member'] = $this->mpesan->td_get_member();
                $this->load->view('pages/vclaim_pending',$t);
	}
	...
	public function ajax_add()
	{
            ...
            $this->admin_log->log_add_claim_pending();
	...
	public function ajax_update()
	{
            ...
            $this->admin_log->log_edit_claim_pending();
            echo json_encode(array("status" => TRUE));
	}
