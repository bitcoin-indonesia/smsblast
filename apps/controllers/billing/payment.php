...
//                $t['payment'] = $this->mpesan->td_get_pay_bill();
//                $t['member'] = $this->mpesan->td_get_member();
//                $a['admin']['datatable']= $this->load->view('billing/payment',$t,true);
//                
//                $this->load->view('pages/vpesan',$a,FALSE);
                $t['payment'] = $this->mpesan->td_get_pay_bill();
                $t['member'] = $this->mpesan->td_get_member();
                $this->load->view('pages/vbill_pay',$t);
	}
	...
	public function ajax_add()
	{
            ...
            $this->admin_log->log_add_billing_payment();
	...
	public function ajax_update()
	{
            ...
            $this->admin_log->log_edit_billing_payment();
            echo json_encode(array("status" => TRUE));
	}
